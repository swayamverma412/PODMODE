...
const VideoPlayer = () => {
  ...
  return (
    <div className="z-[9999] sticky bottom-0 left-0 right-0 top-0 flex items-center  justify-center w-full ">
      <div className="w-full max-w-[1400px] relative flex items-center h-[95vh] justify-between px-8 bg-[#2A2930] shadow-xl text-white ">
        <button
          onClick={() => setCurrentTrack(false)}
          className="absolute text-4xl top-3 right-3"
        >
          <IoClose />
        </button>
        <div className="flex flex-col items-center justify-center w-full gap-6">
          <div className="w-[95vh] mt-10">
            <video
              // width="w-[50vh]"
              height="280"
            ...
            <input
              ...
              step="0.5"
              className="left-0 right-0 top-0 w-full   in-range:bg-gray-200 out-of-range:bg-green-500 h-[4px] bg-gray-200 rounded-t-xl range-sm appearance-none cursor-pointer"
            />
          </div>
